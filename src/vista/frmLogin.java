...
public class frmLogin extends javax.swing.JFrame {
   ...
   /* private void iconoLogin() {
        imagen = new ImageIcon(getClass().getResource("/image/login.png")).getImage();
        ImageIcon icono = new ImageIcon(imagen.getScaledInstance(lblImagen.getWidth(), lblImagen.getHeight(), Image.SCALE_DEFAULT));
        lblImagen.setIcon(icono);
    } */

    /*private void iconoMail() {
        imagen = new ImageIcon(getClass().getResource("/image/mail.png")).getImage();
        ImageIcon icono = new ImageIcon(imagen.getScaledInstance(lblMail.getWidth(), lblMail.getHeight(), Image.SCALE_DEFAULT));
        lblMail.setIcon(icono);
    } */

   /* private void iconoLock() {
        imagen = new ImageIcon(getClass().getResource("/image/lock.png")).getImage();
        ImageIcon icono = new ImageIcon(imagen.getScaledInstance(lblLock.getWidth(), lblLock.getHeight(), Image.SCALE_DEFAULT));
        lblLock.setIcon(icono);
    } */
    ...
    class FondoPanel extends JPanel {
        ...
        public void paint(Graphics g) {
            imagen = new ImageIcon(getClass().getResource("/image/planogreen.png")).getImage();
